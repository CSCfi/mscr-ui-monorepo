...
export default function NodeInfo(props: {
    isAnySelectedLinked: boolean;
    isBothSelectedLinked: boolean;
    sourceData: CrosswalkConnection;
    targetData: CrosswalkConnection;
            ...
            <div className="row d-flex justify-content-between node-info-box">
                ...
                <div className="col-5 flex-column d-flex justify-content-between content-box">
                    <div className="mb-2">
                        ...
                        <div className="source-to-destination-wrap">
                            {props.sourceData.sourceTitle}
                  ...
                  <EastIcon className="arrow-icon" />{' '}
                                    <Button
                                        ...
                                        onClick={() => {
                                            props.performNodeInfoAction(
                                                props.sourceData.target,
                                                true
                                            );
                                        }}
                                    >
