  ...
  function generateFilesData(crosswalkData?: CrosswalkWithVersionInfo) {
    ...
    if (crosswalkData?.format) {
      if (crosswalkData.format === 'MSCR') {
        ...
        // Todo: Only show these next ones when applicable, according to source and target schema formats
        // available through crosswalkData.sourceSchemaInfo.format and crosswalkData.targetSchemaInfo.format
        // see ticket CSCFC4EMSCR-605 for the specifications
        autoGeneratedTable.push({
