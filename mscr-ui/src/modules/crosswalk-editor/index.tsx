...
import MockupSchemaLoader, {getFilterFunctions} from '../crosswalk-editor/schema-mockup';
...
export default function CrosswalkEditor() {
    ...
    // STATE VARIABLES
    let inputData: RenderTree[] = [];
    const [isSourceDataLoading, setSourceDataLoading] = React.useState<boolean>(false);
    const [isSourceDataFetched, setSourceDataFetched] = React.useState<boolean>(false);
    const [mockSourceData, setMockSourceData] = React.useState<RenderTree[] | undefined>([emptyTreeSelection]);
        ...
        if ((add)) {
            ...
            selectedSourceNodes.forEach(sourceNode => {
                ...
                const joint = {
                    ...
                    isSelected: true,
                    isDraft: true,
                    sourceJsonPath: sourceNode.jsonPath,
                    targetJSonPath: selectedTargetNodes[0].jsonPath,
    ...
    return (
        <><Box className='mb-3' sx={{borderBottom: 1, borderColor: 'divider'}}>
            ...
            {selectedTab === 0 && isSourceDataFetched &&
                <>
                    <MetadataAndFiles crosswalks={connectedCrosswalksNew}
            ...
            <div className='row d-flex justify-content-between mt-4 crosswalk-editor'>
                ...
                <div className='col-12'>
                    {selectedTab === 1 && isSourceDataFetched && isEditModeActive &&
                        <>
                            ...
                            <div className='row gx-0'>
                                ...
                                <div className='col-2 px-4 mid-buttons'>
                                    <Sbutton disabled={(linkingError.length > 1)}
                    ...
                    <div className='col-12 px-4 mt-4'>
                        ...
                        <div className='joint-listing-accordion-wrap my-3'>
                            <Box className='mb-4' sx={{height: 640, flexGrow: 1, overflowY: 'auto'}}>
                                <JointListingAccordion crosswalkJoints={connectedCrosswalksNew} viewOnlyMode={false} isEditModeActive={isEditModeActive}
